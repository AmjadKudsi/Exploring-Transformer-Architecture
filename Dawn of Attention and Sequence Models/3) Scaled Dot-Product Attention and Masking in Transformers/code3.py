# complete the create_look_ahead_mask function in the provided code
import torch
...
def create_look_ahead_mask(size):
    ...
    # TODO: Create an upper triangular matrix
    mask = torch.triu(torch.ones(size, size), diagonal=1)
    
    # TODO: Convert to a boolean mask where future positions are False (masked)
