# finish the bahdanau_attention function by implementing the final scoring, normalization, and context computation steps.
import torch
...
def bahdanau_attention(query, keys, values, hidden_size):
    ...
    # TODO: Calculate the scores by passing combined through the v linear layer and squeezing the last dimension
    scores = v(combined).squeeze(-1)
    
    # TODO: Apply softmax to get attention weights
    attention_weights = F.softmax(scores, dim=1)
    
    # TODO: Compute context vector as weighted sum of values using attention_weights
