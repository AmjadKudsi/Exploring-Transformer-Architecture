# complete the missing training function that will train our LSTM models and measure their performance
...
def generate_sequences(seq_length, num_samples=100):
    ...
    targets = sequences[:, 0, 0]  # First element of each sequence
    return sequences, targets.unsqueeze(1)

# TODO: Implement the train_and_evaluate function
# This function should:
# - Take model, sequences, targets, and epochs (default=50) as parameters
# - Set up loss function (MSE) and optimizer (Adam with lr=0.01)
