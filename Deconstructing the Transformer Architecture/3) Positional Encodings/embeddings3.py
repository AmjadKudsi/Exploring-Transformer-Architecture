# Compare the output with the reference heatmap, then carefully review the formulas in the PositionalEncoding class to identify the problem
...
class PositionalEncoding(nn.Module):
    def __init__(self, d_model, max_len=5000, dropout=0.1):
        ...
        # erroneous code: div_term = 10000.0 ** (torch.arange(0, d_model, 2).float() / d_model)
