# fix the TokenEmbedding.forward method to apply the correct scaling factor and complete 
# PositionalEncoding.forward method to combine embeddings with positional information
...
class PositionalEncoding(nn.Module):
    ...
    def forward(self, x):
        ...
        # TODO: Add the positional encodings to the input embeddings
        # Hint: You need to slice self.pe to match the sequence length of x
        seq_len = x.size(1)
        x = x + self.pe[:, :seq_len]
...
class TokenEmbedding(nn.Module):
    ...
    def forward(self, x):
        ...
        # TODO: Scale the embeddings by the square root of the model dimension
