...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, query, key, value, mask=None):
        ...
        # TODO: Use .view() to reshape attention_output 
        attention_output = attention_output.transpose(1, 2).contiguous().view(batch_size, seq_len_q, self.d_model)
        
        # TODO: Apply the final output projection using self.w_o
        output = self.w_o(attention_output)  # Replace this line with the correct implementation
