# complete the initialization logic inside this loop by setting up the weights and biases appropriately
import torch
...
class MultiHeadAttention(nn.Module):
    ...
    def _init_weights(self):
        ...
        for linear in [self.w_q, self.w_k, self.w_v, self.w_o]:
            # TODO: Initialize the weights and biases for each linear layer
