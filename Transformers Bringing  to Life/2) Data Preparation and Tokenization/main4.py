# implement the collate_fn function, which handles dynamic padding for efficient batching
...
def collate_fn(batch):
    ...
    # TODO: Pad sequences to max length in batch using torch.nn.utils.rnn.pad_sequence
